...
const Footer = () => {
    return (
        <footer className="w-full px-10">
            ...
            <div className="w-full grid grid-cols-[2fr_1fr_1fr] max-sm:grid-cols-1 max-sm:gap-5">
            ...
            <div className="text-center p-10 font-light max-sm:p-0 max-sm:py-10">© 2025 TechSonar. All Rights Reserved.</div>

...
const Plan = ({ plan, selectedCycle }) => {
    ...
    return (
        <li className={`flex flex-col gap-6 max-lg:gap-3 bg-secondary-bg/10 backdrop-blur-md rounded-lg p-10 max-lg:p-5 transition duration-300 hover:scale-102 ${isPopular ? "scale-105 hover:scale-108 border border-secondary-border shadow-md shadow-secondary-border" : ""}`}>
            ...
            <div>
                ...
                <ul className="flex flex-col gap-2 max-lg:gap-0.5 mt-4">

...
const WelcomeModal = ({ ref, references }) => {
    ...
    return (
        <div ref={ref} className="relative w-full p-5 h-fit">
            <div className="mx-auto bg-linear-to-b from-gradient-start to-gradient-end w-full rounded-2xl h-265 max-md:h-130 md:max-lg:h-160 lg:max-xl:h-230 max-lg:px-1.5">

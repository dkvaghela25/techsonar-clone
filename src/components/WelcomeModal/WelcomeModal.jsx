...
const WelcomeModal = () => {
    return (
        <div className="relative h-fit">
            <div className="w-full rounded-2xl  bg-linear-to-b from-gradient-start to-gradient-end h-265 max-sm:h-130">
                <Header />
                <div className="flex flex-col gap-10 items-center mt-30 mb-15 max-sm:mt-10 m-auto text-center w-[60%] max-sm:w-full">
                    <div className="text-6xl max-sm:text-3xl font-semibold  leading-18.75 max-sm:leading-10 font-secondary">Stay online. Stay ahead. Website monitoring that just works.</div>

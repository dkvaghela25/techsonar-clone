    ...
    return (
        <div className="relative h-fit">
            <div className="w-full rounded-2xl  bg-linear-to-b from-gradient-start to-gradient-end h-265 max-lg:h-130 sm:max-lg:h-180">
                <Header />
                <div className="flex flex-col gap-10 items-center max-lg:gap-5 mt-30 max-lg:mt-15 mb-15 max-sm:mt-10 m-auto text-center w-[60%] sm:max-lg:w-[80%] max-sm:w-full animate-fadeUp">

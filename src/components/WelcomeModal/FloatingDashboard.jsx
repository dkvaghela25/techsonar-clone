...
const FloatingDashboard = () => {
    return (
        <FadeAnimation axes="Up" >
            <div className="lg:relative md:max-lg:mx-2 -top-112.5 -mb-112.5 max-sm:mb-0  max-sm:mx-0 sm:max-lg:-top-65 sm:max-lg:-mb-65 max-sm:my-4 m-9 rounded-lg overflow-hidden">
                ...
                <img className="w-full" src="./images/dashboard.png" alt="" />
            </div>
        </FadeAnimation>
    );
};

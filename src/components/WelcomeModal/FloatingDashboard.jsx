...
const FloatingDashboard = () => {
    return (
        <FadeAnimation axes="Up" >
            <div className="flex">
                <div className="px-15 mx-auto max-md:px-5 md:relative md:max-lg:mx-2 -top-112.5 -mb-112.5 max-sm:mb-0  max-sm:mx-0 sm:max-lg:-top-65 sm:max-lg:-mb-65 max-sm:my-4 m-9 rounded-lg overflow-hidden">
                    <div className="max-w-400 bg-primary-bg flex justify-between px-6 py-3 max-sm:px-3 max-sm:py-1.5 items-center">
                    ...
                    <img className="w-full max-w-400" src="./images/dashboard.png" alt="" />
                </div>
            </div>
        </FadeAnimation>
    );

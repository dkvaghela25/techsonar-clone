const Review = ({ review }) => {
    ...
    return (
        <div class="shrink-0 px-4 w-[33.33%] min-w-[33.33%] sm:max-xl:w-[50%] sm:max-xl:min-w-[50%] max-sm:w-full max-sm:min-w-full ">
            <div className="bg-secondary-bg/10 backdrop-blur-md p-10 max-lg:p-6 rounded-lg">
